    ...
    return (
        <ScrollView>
            <View className='bg-white container mx-auto px-8'>
                ...
                <Text className="font-visbyBold text-3xl my-3" style={{ color: `${userTema.primary2}` }}>Hasnat Ferdiananda</Text>
                ...
                {/* ABOUT ME */}
                <View>
                    <Text className="font-visbyBold text-xl underline my-4" style={{ color: `${userTema.primary2}` }}>About Me</Text>
                ...
                {/* FAVORITE */}
                <View>
                    <Text className='font-visbyBold text-xl underline my-4' style={{ color: `${userTema.primary2}` }}>I ♥</Text>
                ...
                {/* LINKING */}
                <View className='mb-4'>
                    <Text className='font-visbyBold text-xl underline my-4' style={{ color: `${userTema.primary2}` }}>Social</Text>
                    <Pressable onPress={() => Linking.openURL('https://github.com/hasnat5')}>
                        <View className='pl-4 flex-row items-center h-10'>
                            <Icon name='logo-github' size={24} color={userTema.primary2} />
                            <Text className="text-base ml-2" style={{ color: `${userTema.primary2}` }}>@hasnat5</Text>
                        </View>
                    </Pressable>
                    <Pressable onPress={() => Linking.openURL('https://www.linkedin.com/in/hasnatf')} >
                        <View className='pl-4 flex-row items-center h-10'>
                            <Icon name='logo-linkedin' size={24} color={userTema.primary2} />
                            <Text className="text-base ml-2" style={{ color: `${userTema.primary2}` }}>@hasnatf</Text>
                        </View>
                    </Pressable>
                    <Pressable onPress={() => Linking.openURL('https://www.instagram.com/hasnat5_/')}>
                        <View className='pl-4 flex-row items-center h-10'>
                            <Icon name='logo-instagram' size={24} color={userTema.primary2} />
                            <Text className="text-base ml-2" style={{ color: `${userTema.primary2}` }}>@hasnat5_</Text>
                        </View>
                    </Pressable>
                    <Pressable onPress={() => Linking.openURL('https://www.youtube.com/@hasnat5_')}>
                        <View className='pl-4 flex-row items-center h-10'>
                            <Icon name='logo-youtube' size={24} color={userTema.primary2} />
                            <Text className="text-base ml-2" style={{ color: `${userTema.primary2}` }}>@hasnat5_</Text>
                        </View>
                    </Pressable>
                </View>
